 ...
 */
public class UpdateLocationSampleServlet extends HttpServlet {

  private static final Logger log = LoggerFactory.getLogger(UpdateLocationSampleServlet.class);
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    documentation.append("The server will update an existing LocationSample based on the JSON request.\n");
    documentation.append("\n");
    documentation.append("JSON request:\n");
    documentation.append("{\n");
    documentation.append("\n");
    documentation.append("  \"accountIdentity\": Required. String value. Must be the same as the account that created the location sample.\n");
    ...
    documentation.append("\n");
    documentation.append("  \"provider\": Optional. String value. Source of location, e.g. 'gps', 'network', 'human', etc.\n");
    documentation.append("  \"accuracy\": Optional. Double value. Maximum error in meters.\n");
    documentation.append("  \"latitude\": Optional. Double value. EPSG:3857\n");
    documentation.append("  \"longitude\": Optional. Double value. EPSG:3857\n");
